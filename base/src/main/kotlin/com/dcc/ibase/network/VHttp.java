...
import com.dcc.ibase.network.request.BaseHttpRequest;
import com.dcc.ibase.network.request.DeleteRequest;
import com.dcc.ibase.network.request.DownloadRequest;
import com.dcc.ibase.network.request.GetRequest;
import com.dcc.ibase.network.request.HeadRequest;
import com.dcc.ibase.network.request.OptionsRequest;
import com.dcc.ibase.network.request.PatchRequest;
import com.dcc.ibase.network.request.PostRequest;
import com.dcc.ibase.network.request.PutRequest;
import com.dcc.ibase.network.request.RetrofitRequest;
import com.dcc.ibase.network.request.UploadRequest;
...
public class VHttp {
    ...
    private static final VHttpGlobalConfig NET_GLOBAL_CONFIG = VHttpGlobalConfig.getInstance();

    public static VHttpGlobalConfig CONFIG() {
    ...
    public static Context getContext() {
        if (context == null) {
            throw new IllegalStateException("Please call VHttp.init(this) in Application to initialize!");
        }
        return context;
    }
