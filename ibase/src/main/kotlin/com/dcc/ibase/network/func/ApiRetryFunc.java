package com.dcc.ibase.network.func;

import com.dcc.ibase.log.LogManager;
import com.dcc.ibase.network.exception.ApiException;
                ...
                .flatMap(new Function<Throwable, ObservableSource<?>>() {
                    ...
                    public ObservableSource<?> apply(Throwable throwable) throws Exception {
                        if (++retryCount <= maxRetries && (throwable instanceof SocketTimeoutException
                            ...
                            LogManager.Companion.d("get response data error, it will try after " + retryDelayMillis
