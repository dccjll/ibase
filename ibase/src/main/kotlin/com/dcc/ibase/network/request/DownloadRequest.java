...
import com.dcc.ibase.network.mode.DownProgress;
import com.dcc.ibase.network.subscriber.DownCallbackSubscriber;
...
public class DownloadRequest extends BaseHttpRequest<DownloadRequest> {
    ...
    private String dirName = VHttpStatics.DEFAULT_DOWNLOAD_DIR;
    private String fileName = VHttpStatics.DEFAULT_DOWNLOAD_FILE_NAME;

    public DownloadRequest(String suffixUrl) {
        super(suffixUrl);
        rootName = getDiskCachePath(VHttp.getContext());
    }
