 ...
 */
public class IGTIntentService extends GTIntentService {

    private static final String TAG = "IGTIntentService";

    public static final String TAG_CLIENT = TAG + "CLIENT";
    public static final String TAG_PUSHMSG = TAG + "PUSHMSG";
    ...
    public void onReceiveClientId(Context context, String clientid) {
        ...
        RxUtils.post(clientid, TAG_CLIENT);
    }
